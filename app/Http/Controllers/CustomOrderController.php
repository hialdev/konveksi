...
class CustomOrderController extends Controller
{
    ...
    public function add(){
        ...
        return view('custom_orders.add', compact('raw_materials', 'products', 'customers'));
    }
    ...
    public function store(Request $request){
        ...
        try {
            ...
            $custom->keterangan = $request->get('description');
            $custom->qty = $request->get('qty');
            $custom->deadline = $request->get('deadline');
            $custom->save();

            return redirect()->back()->with('success', 'Pesanan Khusus dibuat dengan kode '.$custom->code.'.');
        } catch (\Exception $e) {
    ...
    public function edit($id){
        ...
        $raw_materials = RawMaterial::where('cek_tersedia', 1)->orderBy('nama', 'asc')->get();
        $products = Product::orderBy('nama', 'asc')->get();
        return view('custom_orders.edit', compact('corder', 'raw_materials', 'products', 'customers'));
    }
    ...
    public function update(Request $request, $id){
        ...
        try {
            ...
            return redirect()->back()->with('success', 'Pesanan Khusus berhasil diperbaharui dengan kode '.$custom->code.'.');
        } catch (\Exception $e) {
