...
@section('content')
                ...
                <div class="col-9">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Semua Rekening Bank</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-3">
    ...
    <div class="mb-3 d-flex align-items-center gap-2 justify-content-between">
        ...
        <div style="aspect-ratio:1/1; width:3em; height:3em"
            ...
            {{ count($banks) }}</div>
        <a href="{{ route('bank.add') }}" class="btn btn-primary btn-al-primary">Tambah</a>
    </div>
            ...
            <form action="{{route('bank.index')}}" method="GET">
                <div class="row align-items-end mb-3 flex-wrap">
                    <div class="col-md-4 mb-2">
                        ...
                        <input type="text" class="form-control" placeholder="Cari Nama / No Rek" name="search" value="{{$filter->q ?? ''}}">
                    </div>
                    <div class="col-md-3 mb-2">
                        <label for="field" class="form-label">Urutkan Berdasarkan</label>
                        <select name="field" id="field" class="form-select">
                            @foreach (getModelAttributes('Bank', ['logo']) as $atr)
                    ...
                    <div class="col-md-2 mb-2">
                        <div class="d-flex align-items-center gap-1">
                            ...
                            <a href="{{route('bank.index')}}" class="btn btn-secondary" style="white-space: nowrap">
                ...
                <table class="table border text-nowrap mb-0 align-middle">
                    <thead class="text-dark fs-4">
                        <tr>
                            ...
                            <th>
                                <h6 class="fs-3 fw-semibold mb-0">Data Rekening</h6>
                            </th>
                            <th>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center" >
                                        <img src="{{ $bank->logo ? asset('storage/' . $bank->logo) : '/assets/images/profile/user-1.jpg' }}"
                                            class="rounded-2" alt="Bank Logo {{ $bank->nama_bank }}" style="width: 4em" />
                                        <div class="ms-3">
                                            <h6 class="fw-semibold mb-1">{{ $bank->nama_bank }}</h6>
                                            <span class="fw-normal text-muted line-clamp line-clamp-2"
                                                style="white-space:normal; font-size:13px; ">{{ $bank->keterangan }}</span>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="fs-4 fw-bold text-dark">a.n {{$bank->nama_rekening}}</div>
                                    <div class="fs-3 fw-bold text-primary">{{$bank->no_rekening}}</div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="dropdown dropstart">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <li>
                                                <a href="{{route('bank.edit', $bank->id)}}" class="dropdown-item d-flex align-items-center gap-3"><i
                                                        class="fs-4 ti ti-edit"></i>Edit</a>
                                            </li>
                                            <li>
                                                <button type="button" class="dropdown-item d-flex align-items-center gap-3"
                                                    data-bs-toggle="modal" data-bs-target="#deleteModal-{{$bank->id}}"><i
                                    ...
                                    <!-- Delete Modal -->
                                    <div id="deleteModal-{{$bank->id}}" class="modal fade" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                                            <div class="modal-content p-3 modal-filled bg-danger">
                                                ...
                                                <div class="modal-body" style="width: fit-content; white-space:normal">
                                                    <h5 class="mt-0 text-white">Bank {{$bank->nama_bank}} akan dihapus</h5>
