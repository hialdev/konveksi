...
@section('content')
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Pesanan Menunggu Verifikasi</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a class="text-muted text-decoration-none" href="{{ route('home') }}">Dashboard</a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page">Semua Pesanan Menunggu Verifikasi</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-3">
    ...
    <div class="mb-3 d-flex align-items-center gap-2 justify-content-between">
        <h1>Pesanan Menunggu Verifikasi</h1>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{route('order.waiting')}}" method="GET">
                                ...
                                <td>
                                    @switch($order->status)
                                        @case('1')
                                            ...
                                            @break
                                        @case('2')
                                            <div class="p-1 px-2 bg-success text-white fs-2 rounded-2 d-inline-block">Valid - Diproses</div>
                                            @break
                                        @case('3')
                                ...
                                <td>
                                    <div class="dropdown dropstart">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <li>
                                                <a href="{{route('order.payment', $order->id)}}" class="dropdown-item d-flex align-items-center gap-3 text-primary">
                                                    <i class="fs-4 ti ti-upload"></i>Upload Ulang   
                                                </a>
                                            </li>
                                            @endif
                                            <li>
