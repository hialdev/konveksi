                ...
                <div class="col-9">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Manage Pelanggan</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-3">
                ...
                <table class="table border text-nowrap mb-0 align-middle">
                    <thead class="text-dark fs-4">
                        <tr>
                            ...
                            <th>
                                <h6 class="fs-3 fw-semibold mb-0">Orders</h6>
                            </th>
                            <th>
                                <h6 class="fs-3 fw-semibold mb-0">Custom Orders</h6>
                            </th>
                            <th>
                    ...
                    <tbody>
                        @forelse ($customers as $customer)
                            <tr>
                                <td>
                                    <div class="fw-semibold fs-3 {{ $customer->nama ? '' : 'text-danger'}}">
                                        {{ $customer->nama ?? 'No Name' }}</div>
                                    <p class="fs-2 text-muted mb-0">{{ $customer->email }}</p>
                                </td>
                                <td>
                                    <div>{{ $customer->orders->count() }}</div>
                                </td>
                                <td>
                                    <div>{{ $customer->customOrders->count() }}</div>
                                </td>
                                <td>
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header d-flex align-items-center">
                                                    <h4 class="modal-title" id="myLargeModalLabel">
                                                        Perbarui Customer {{$customer->nama}}
                                                    </h4>
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('customer.update', $customer->id) }}" method="POST">
                                                        ...
                                                        <input type="text" name="name" class="form-control mb-2" value="{{ old('name', $customer->nama) }}"
