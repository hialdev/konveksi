...
@section('content')
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Pesanan Khusus Saya</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a class="text-muted text-decoration-none" href="{{ route('home') }}">Dashboard</a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page">Semua Pesanan Khusus Saya</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-3">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{route('custom-order.my')}}" method="GET">
                <div class="row align-items-end mb-3 flex-wrap">
                    <div class="col-md-4 mb-2">
                        <label for="search" class="form-label">Filter Kata</label>
                        <input type="text" class="form-control" placeholder="Cari Kode" name="search" value="{{$filter->q ?? ''}}">
                    </div>
                        ...
                        @forelse ($custom_orders as $corder)
                            <tr>
                                ...
                                <td>
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <li>
                                                <button type="button" class="dropdown-item d-flex align-items-center text-danger gap-3"
                                                    data-bs-toggle="modal" data-bs-target="#returModal-{{$corder->id}}">
                                    ...
                                    <!-- Retur Modal -->
                                    <div class="modal fade" id="returModal-{{$corder->id}}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body pt-0" style="white-space: normal !important">
                                                    <form action="{{ route('custom-order.retur', $corder->id) }}" method="POST">
                                                        @csrf
                                ...
                                <td colspan="8">
                                    <div class="bg-light p-3 rounded-3">
                                        <div class="d-flex align-items-center gap-4">
                                            ...
                                            @if($corder->status >= '4')
                                            <div>
                                                <a href="{{route('custom-order.payment.index', $corder->id)}}" class="d-flex btn-sm align-items-center gap-2 btn btn-primary">
